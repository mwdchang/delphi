...
def petasce__decision__kcb_2(IF_4_0, kcb_1, kcb_0):
    return kcb_0 if IF_4_0 else kcb_1
...
def petasce__decision__fc_2(IF_6_0, fc_1, fc_0):
    return fc_0 if IF_6_0 else fc_1
